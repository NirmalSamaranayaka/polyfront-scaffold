...
const QUICK_BASE = [
  ...
  { fw: 'react-webpack', ui: 'tailwind', store: 'none', unit: 'vitest', e2e: 'none', date: 'date-fns' },  { fw: 'react-webpack', ui: 'antd', store: 'none', unit: 'vitest', e2e: 'none', date: 'date-fns' },
...
// Angular minimal set (optional)
const ANGULAR_UIs = ['material', 'bootstrap', 'tailwind', 'primeng'];
for (const ui of ANGULAR_UIs) {
  FULL_BASE.push({
    fw: 'angular',
    ui,
    store: 'none',
