  ...
  <div class="flex-1 flex flex-col">
    ...
    <header class="bg-white border-b border-gray-200 p-4 flex justify-between items-center">
      ...
      <div class="flex items-center gap-3">
        <span class="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-sm">v0.0.38</span>
        <select title="Select Language" class="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-sm">
