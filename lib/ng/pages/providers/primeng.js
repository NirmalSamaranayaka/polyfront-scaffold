    ...
    <div class="info-grid">
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Full Name" pInputText [readonly]="true" [value]="content.profile.name" class="readonly-input" />
        </div>
      </div>
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Email" pInputText [readonly]="true" [value]="content.profile.email" class="readonly-input" />
        </div>
      </div>
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Phone" pInputText [readonly]="true" [value]="content.profile.phone" class="readonly-input" />
        </div>
      </div>
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Location" pInputText [readonly]="true" [value]="content.profile.location" class="readonly-input" />
        </div>
      </div>
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Company" pInputText [readonly]="true" [value]="content.profile.company" class="readonly-input" />
        </div>
      </div>
      ...
      <div class="info-field">
        ...
        <div class="control-row">
          ...
          <input placeholder="Position" pInputText [readonly]="true" [value]="content.profile.position" class="readonly-input" />
        </div>
      </div>
    </div>
  </ng-template>
