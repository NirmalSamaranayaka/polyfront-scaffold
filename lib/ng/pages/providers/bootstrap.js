    ...
    <div class="col-md-6">
      <div class="card h-100 shadow-sm">
        <div class="card-header bg-white border-0 pb-0">
          <h4 class="card-title mb-0 text-primary">Technology Stack</h4>
        </div>
        <div class="card-body">
            ...
            @for (tech of content.techStack; track tech.name) {
              <div class="col-6 col-sm-4 text-center">
                <div class="d-flex flex-column align-items-center">
                  <span class="badge bg-primary mb-1 px-3 py-2">
                    {{ tech.name }} {{ tech.version }}
                  </span>
                  <small class="text-secondary">{{ tech.category }}</small>
                </div>
              </div>
            }
          </div>
        ...
        @for (benefit of content.benefits; track benefit.title) {
          <div class="col-md-4">
            <div class="text-center">
              <i 
                class="bi bi-{{ benefit.icon }} me-2 fs-1" 
                [ngStyle]="{'color': benefit.color}">
              </i>
      ...
      <div class="card text-center">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i class="bi bi-currency-dollar text-success  me-2 fs-1"> </i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card text-center">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i class="bi bi-cart2 text-warning  me-2 fs-1"> </i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card text-center">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i class="bi bi-eye-fill text-info  me-2 fs-1"> </i>
          </div>
        </div>
      </div>
    </div>
            ...
            @for (activity of content.recentActivity; track activity.id) {
              <div class="list-group-item d-flex align-items-start">
                <i
                    class="bi me-2 fs-4"
                    [ngClass]="{
                      'bi-check-circle text-success': activity.status === 'success',
                      'bi-exclamation-triangle text-warning': activity.status === 'warning',
                      'bi-x-circle text-danger': activity.status === 'error'
                    }">
                  </i>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" placeholder="Full Name" class="form-control" [value]="content.profile.name" readonly>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="email" placeholder="Email" class="form-control" [value]="content.profile.email" readonly>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="tel" placeholder="Phone" class="form-control" [value]="content.profile.phone" readonly>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" placeholder="Location" class="form-control" [value]="content.profile.location" readonly>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="text" placeholder="Company" class="form-control" [value]="content.profile.company" readonly>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                <span class="input-group-text"><i class="bi bi-briefcase"></i></span>
                <input type="text" placeholder="Position" class="form-control" [value]="content.profile.position" readonly>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="list-group list-group-flush">
            <div class="list-group-item d-flex justify-content-between align-items-center">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" placeholder="Email Notifications" type="checkbox" [checked]="content.settings.emailNotifications" disabled>
              </div>
            </div>
            <div class="list-group-item d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" placeholder="Push Notifications" type="checkbox" [checked]="content.settings.pushNotifications" disabled>
              </div>
            </div>
            <div class="list-group-item d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" placeholder="Dark Mode" type="checkbox" [checked]="content.settings.darkMode" disabled>
              </div>
            </div>
            <div class="list-group-item d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
              ...
              <div class="form-check form-switch">
                <input class="form-check-input" placeholder="Two-Factor Auth" type="checkbox" [checked]="content.settings.twoFactorAuth" disabled>
              </div>
            </div>
          </div>
        </div>
