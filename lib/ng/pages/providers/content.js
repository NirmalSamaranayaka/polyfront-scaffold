...
function getPageContent(ui = "material") {
  ...
  return {
    ...
    about: {
      ...
      benefits: [
        { icon: preset.icons.benefits.production, title: "Production Ready", description: "Built with best practices and industry standards" },
        { icon: preset.icons.benefits.fast, title: "Fast Development", description: "Hot reload and instant feedback for rapid iteration" },
        { icon: preset.icons.benefits.team, title: "Team Friendly", description: "Consistent code style and comprehensive tooling" }
      ]
    },
    dashboard: {
      title: "Dashboard",
