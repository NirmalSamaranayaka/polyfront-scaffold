      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.name" readonly>
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">📧</span>
            <input type="email" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.email" readonly>
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">📞</span>
            <input type="tel" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.phone" readonly>
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">📍</span>
            <input type="text" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.location" readonly>
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">🏢</span>
            <input type="text" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.company" readonly>
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">💼</span>
            <input type="text" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100" [value]="content.profile.position" readonly>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="space-y-4">
        <div class="flex justify-between items-center">
          ...
          <input type="checkbox" class="w-4 h-4" [checked]="content.settings.emailNotifications" disabled>
        </div>
        <div class="flex justify-between items-center">
          <div class="flex items-center">
            <span class="mr-3">📱</span>
          ...
          <input type="checkbox" class="w-4 h-4" [checked]="content.settings.pushNotifications" disabled>
        </div>
        <div class="flex justify-between items-center">
          <div class="flex items-center">
            <span class="mr-3">🎨</span>
          ...
          <input type="checkbox" class="w-4 h-4" [checked]="content.settings.darkMode" disabled>
        </div>
        <div class="flex justify-between items-center">
          <div class="flex items-center">
            <span class="mr-3">🔒</span>
          ...
          <input type="checkbox" class="w-4 h-4" [checked]="content.settings.twoFactorAuth" disabled>
        </div>
      </div>
    </div>
  </div>
