              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    disabled={!isEditing}
                    InputProps={{
                      startAdornment: <LocationOn sx={{ mr: 1, color: '1', color: 'text.secondary' }} />
                    }}
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
...
function createI18nFiles(srcDir, ext) {
...
function createDateUtils(srcDir, dateLib, ext) {
...
function createCommonUtils(srcDir, ext) {
