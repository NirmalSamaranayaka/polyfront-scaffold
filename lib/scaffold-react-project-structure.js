      ...
      <AppBar position="fixed" sx={{ zIndex: theme.zIndex.drawer + 1 }}>
        <Toolbar>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Chip label="v1.0.23" size="small" variant="outlined" />
        ...
        <header className="bg-white border-bottom p-3">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex align-items-center gap-2">
              <span className="badge bg-secondary">v1.0.23</span>
            ...
            <div className="flex-1">
              ...
              <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                  {/* Version */}
                  <span className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-sm">v1.0.23</span>
  ...
  return (
    <AntLayout style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <Tag bordered={false}>v1.0.23</Tag>
        <Select
          size="small"
          value={currentLang}
          onChange={handleLanguageChange}
