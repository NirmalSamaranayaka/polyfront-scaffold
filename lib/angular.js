...
@import 'primeflex/primeflex.css';\n`);
  ...
  // Replace default welcome page with router-only shell
  try {
...
function replaceDefaultAppShell(projectDir) {
  const appCmpTs = path.join(projectDir, "src", "app", "app.component.ts");
  const appCmpHtml = path.join(projectDir, "src", "app", "app.component.html");
